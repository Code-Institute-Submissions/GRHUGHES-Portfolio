...
1. As an employer, I want to see what Gary is capable of doing as a software developer by seeing examples of his work so that I have an idea if he is a good fit for my available position within our company.
...
3. As a software development student, I'm looking for design ideas and inspiration for my project, so that I can do well in my course.
...
- Shades of blue are used for the navbar text, heading text and buttons. White boxes form the areas of content with primarily black text and sit on top of a black background for the whole website. Bright orange provides the accent and outlines.
...
I have listed my opportunities to include in my website and rated each on a scale of 1 to 5 in terms of importance and viability or feasibility to determine what I will include in my first deployment and what will be left out at least for the time being. For me, creating a minimal online presence is the primary goal followed by displaying a work portfolio. Increasing GitHub followers is the least important opportunity and is not viable at the moment.
...
My website consists of 4 pages all easily accessible from the navbar on larger screen sizes or toggler "_hamburger_" button on smaller screen sizes. All external links, including links to my projects and social media, open in separate tabs so the flow is not disturbed. On larger screen sizes the navigation stays fixed to the top of the page even during scrolling. All text and content have been positioned from left to right and top to bottom in terms of importance. The title of the active page in the navigation appears a darker shade of blue than the inactive pages in a subtle way of letting the user know where they within the website. My name logo is positioned to the left of the navbar and when clicked on will return the user to the homepage. Each page title when hovered over will appear highlighted and underlined in orange to visualise to the user that this is a "_clickable_" action.
...
Predominantly mono colours were chosen for the backdrop with splashes of colour giving an extra pop to create a modern and attractive look.

<hr>

## Current Features

- Responsive to all device sizes make the website easily accessible and simple to navigate.
...
In future, I would like to expand the skill set section with newly acquired skills as I progress through my course and more projects I hope to work on to create a more comprehensive display of my work. I would also like to include more animation techniques with elements and use JavaScript.
...
1. [Bootstrap 4.5.0](https://getbootstrap.com/docs/4.5/getting-started/introduction/) - Bootstrap was used behind the existing HTML and CSS as the core structuring method of the website, using a grid system of rows and columns. This produces a responsive and mobile-first design.
...
5. [jQuery 3.5.1](https://jquery.com/) - jQuery comes as part of the Bootstrap framework and was used to provide responsive expandable and collapsable functionality to the navbar.
...
7. [GitHub](https://github.com/Gazroh87/GRHUGHES-Portfolio) - GitHub is used to store the project's code within a repository including all previous versions or commits of the project after being pushed from Gitpod and is used to host the deployed website for public viewing.

8. [Adobe Illustrator](https://www.adobe.com/uk/products/illustrator.html) - Adobe Illustrator was used in the creation of my logo at the top of this file and placed within the Hero image of my homepage, resizing and editing of photos for the website.

9. [tiny png](https://tinypng.com/) - Tiny png was used to compress the images used throughout the website to reduce data size, decreasing load times without sacrificing the integrity or quality of the original images.
...
12. [Shutterstock](https://www.shutterstock.com/home) - Shutterstock provides the stock hero imagery of my website.
...
14. [htmlcolorcodes.com built by Dixon & Moe](https://htmlcolorcodes.com/) - HTML colour codes was used to choose my colour scheme and obtain the corresponding hex codes for each colour.
...
1. As an employer, I want to see what Gary is capable of doing as a software developer by seeing examples of his work so that I have an idea if he is a good fit for my available position within our company.
   ...
   2. In the Projects page, the user can see an image and brief description of each project and each project has a clickable link to take the user to the GitHub repository or live website in a separate browser tab.
...
2. As a software development collaborator, I want an easy and appropriate way of contacting Gary with my collaboration idea, so that we can work together on something.
   ...
   2. In the Collaboration page, the user can fill out a simple contact form with their name, email address to be contacted back and a message with their collaboration idea.
      ...
      - When the user tries to submit the contact form with an empty field, a message will pop up, telling the user to enter text into the required field(s).
...
4. As a recruitment agent, I want to see a broader overview of Gary by seeing his full resume and I expect to be able to easily download a copy of his CV for my records so that I can determine whether Gary can be shortlisted for any of the available positions I need to fill.
   ...
   3. In the Resume page, the user can download a copy of my CV by clicking/tapping the link to open my CV in a pdf file in a new browser tab.
   4. They can view my skill set concerning coding and education, training and work history timelines.

### Further Testing

- Throughout the building process of the website, I conducted regular testing through the use of Google Chrome DevTools (with Chrome being my default and primary browser used for this project).
- Beginning from the mobile-first perspective, every element of each page was tested to ensure they appear and function as desired and expected. When enabling the DevTools Inspector and toggling the device toolbar I was able to select specific device screen sizes or an unlimited responsive option for testing purposes.
...
- Whenever I encountered something not appearing or functioning as it should, I would first try to rectify the problem with the DevTools elements panel by applying a fix. If this fix was successful, it would be replicated in Gitpod. If the fix was unsuccessful, my attention would turn to an online resource(s) or Slack, to help identify why the problem is occurring, if there are any underlying issues and workarounds or asking for advice to tackle the problem.
...
- Fix: Removed the extra hyphens in comments, thanks to [Geert Bormans](https://www.experts-exchange.com/questions/28661509/The-document-is-not-mappable-to-XML-1-0-due-to-two-consecutive-hyphens-in-a-comment.html).
...
- The Personal Info section idea and implementation remain largely the same as used in Code Institute's UCD Rosie Resume Mini Project.
...
- Credit to Merangely Asensi for the script to close the hamburger menu after clicking/tapping the button or making a selection, found [here](https://codepen.io/imprfcto/pen/WNNpBLp).
...
- The hero images used in my website were obtained from [Shutterstock](https://www.shutterstock.com/home) and edited in [Adobe Illustrator](https://www.adobe.com/uk/products/illustrator.html), except for the photo of myself in the 'Personal Info' section of the 'Resume' page.
- The icons used in my website were obtained from [Font Awesome](https://fontawesome.bootstrapcheatsheets.com/) and styled by me.

### Special thankyous / Acknowledgements
...
- Credit to Skelly aka Zim at Stack Overflow for help with the following:
    - Changing Navbar colour in Bootstrap, found [here](https://stackoverflow.com/questions/18529274/change-navbar-color-in-twitter-bootstrap/18530995#18530995).
